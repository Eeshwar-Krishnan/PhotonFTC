...
class PhotonLynxSetMotorPIDFControlLoopCoefficientsCommand(
    ...
    d: Int,
    f: Int,
    motorControlAlgorithm: InternalMotorControlAlgorithm?
) :
    LynxSetMotorPIDFControlLoopCoefficientsCommand(module, motorZ, mode, p, i, d, f, motorControlAlgorithm) {
